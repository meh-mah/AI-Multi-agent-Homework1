 ...
 * @author M&M
 */
public class TourGuideAgentv1 extends Agent {
    
    private AID [] curatorAgents;
    // map is used since it cannot contain dupplicated key
    private Map<Artifact, AID> artifactsAndCurators = new HashMap<>();
    ...
    private class TourGuideBehaviour extends ParallelBehaviour {
        ...
        public TourGuideBehaviour(Agent a) {
            ...
            addSubBehaviour(new CyclicBehaviour(a) {
                ...
                public void action() {
                    ...
                    if (msg != null) {
                        ...
                        System.out.println(myAgent.getAID().getName() + " received request for tour from"+ msg.getSender().getName());

                       // create a map contain the name of listOfArtifacts and their curator, which are match profiler's interest
                        Map<String, AID> replyMap = new HashMap<String, AID>();
            ...
            addSubBehaviour(new TickerBehaviour(a, 6000) {
                @Override
                protected void onTick() {
                    ...
                    for(int i=0; i<curatorAgents.length; i++){
                        ...
                        myAgent.send(req);
                        // prepare template to get the list of artifacts reply
            ...
            addSubBehaviour(new MsgReceiver(a, mt, 30000, null, null) {
                @Override
                public void action() {
